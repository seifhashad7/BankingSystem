...
namespace BankingSystem.ViewModel
{
    public class CustomerDashboardViewModel : ViewModelBase
    {
        ...
        public CustomerDashboardViewModel(BankSystem bankSystem)
        {
        ...
        {
            Transactions = new ObservableCollection<Transaction>(_bankSystem.GetTransactionsPerAccount(AccountId));
        ...
        private void ExecuteLoadTotalBalance(object o)
        {
            ...
            {
                new TableSet { Category="Account Balance", RecordCounts= _bankSystem.GetBalance(AccountId)}
            };
        ...
        private void ExecuteLoadTotalTransactions(object o)
        {
            ...
            {
                new TableSet { Category="Total Transactions", RecordCounts= _bankSystem.GetTotalTransactionsPerAccount(AccountId)}
            };
